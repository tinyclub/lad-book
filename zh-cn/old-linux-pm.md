...
|Keven |项目经理|帮助大家制定计划，辅助各模块负责人把控考古质量和成果|多年内核驱动开发经验，项目推动者|
|      |开发经理| ||
|      |开发经理| ||
...
|:----:|:----:|:----:|:----:|:----:|----:|
|A|Linux Kernel 发展史|历史、硬件、编程语言||5|
...
|F|Linux Kernel 内存管理|内存管理|Axl Keven tom <br/> 牛奶咖啡.燕涛|5|
|G|Linux Kernel 库文件，头文件，以及编译规则|头文件、库文件、编译规则|陈恩召|5|
